 ...
 * By default, mpesa4j.config.PropertyConfigurationFactory will be used.
 */
public final class ConfigurationContext {
  private static final String DEFAULT_CONFIGURATION_FACTORY =
      "mpesa4j.config.PropertyConfigurationFactory";
  private static final String CONFIGURATION_IMPL = "mpesa4j.configurationFactory";
