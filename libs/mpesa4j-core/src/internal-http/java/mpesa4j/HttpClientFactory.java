...
import mpesa4j.config.ConfigurationContext;

public final class HttpClientFactory {
  private static final Constructor<?> HTTP_CLIENT_CONSTRUCTOR;
  private static final String HTTP_CLIENT_IMPLEMENTATION = "mpesa4j.http.httpClient";
  ...
  static {
    ...
    if (null == clazz) {
      try {
        clazz = Class.forName("mpesa4j.HttpClientImpl");
